        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <ul class="mb-0 ps-3">
                            @foreach ($item->catatanpelanggarans as $cp)
                                <li>
                                    {{ $cp->pelanggaran->nama_pelanggaran ?? '-' }}
                                    ({{ $cp->pelanggaran->point ?? 0 }} poin)
                                </li>
                            @endforeach
                            <strong>Total: {{ $item->catatanpelanggarans->sum(fn($cp) => $cp->pelanggaran->point ?? 0) }} poin</strong>
                        </ul>
                    </td>
                    ...
                    {{-- // tanggal terakhir siswa mendapatkan pelanggaran --}}
                    <td>
                        {{
                            optional(
                                $item->catatanpelanggarans->sortByDesc('created_at')->first()
